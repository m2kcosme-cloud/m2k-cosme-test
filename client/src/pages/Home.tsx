      ...
      <section className="container py-32 lg:py-48 border-t border-border">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
          {[
            ...
            <Link key={index} href={ingredient.path}>
              <a className="group cursor-pointer fade-in-up" style={{ animationDelay: `${index * 100}ms` }}>
                ...
                <h3 className="mb-2 group-hover:text-primary transition-colors">{ingredient.name}</h3>
                <p className="text-muted-foreground">{ingredient.subtitle}</p>
              </a>
            </Link>
          ))}
        </div>
